...
const Body = () => {
  return (
    <div className='space-y-4 lg:flex'>
      ...
      <img src='./assets/Blue-Shape.svg' alt="logo" className='-rotate-45 h-64 md:h-72 lg:h-[400px]' />
      <img src='./assets/Pink-Shape.svg' alt="logo" className='absolute -rotate-[30deg] h-64 md:h-72 lg:h-[400px]'/>
      <img src='./assets/Purple-Shape.svg' alt="logo" className='absolute -rotate-[15deg] h-64 md:h-72 lg:h-[400px]'/>
      <img src='./assets/Hero-Model.png' alt="logo" className='absolute h-64 md:h-72 lg:h-[400px]'/>
    </div>
